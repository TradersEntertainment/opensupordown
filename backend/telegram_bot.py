...
async def handle_ai_chat(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    intent_system_prompt = (
        ...
        "- 'action': 'analyze' if they ask to track, analyze, or check risk of a symbol from watchlist. Otherwise 'chat'.\n"
        "- 'symbol': The matched uppercase symbol from watchlist (e.g. 'PLTR', 'WTI', 'XAU', 'TSLA'). Null if not found.\n"
        "- 'threshold': The target price target/barrier they mentioned (e.g. 25.5, 80.0, 3500). Null if not found.\n"
